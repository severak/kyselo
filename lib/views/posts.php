...
if (empty($user)) {
	...
	if (!empty($blog) && $blog['name']!=$user['name'] && $blog['is_group']) {
		...
		if ($membership) {
            echo '<a href="#post_types" id="new_post" class="pure-button button-large"><i class="fa fa-pencil"></i><span class="kyselo-hidden"> new post</span></a>';
            echo '<span id="post_types">';
            echo '<a href="/act/post?as='.$blog['name'].'&type=1" class="pure-button button-large"><i class="fa fa-book"></i><span class="kyselo-hidden"> new post</span></a>';
            echo '<a href="/act/post?as='.$blog['name'].'&type=2" class="pure-button button-large"><i class="fa fa-link"></i><span class="kyselo-hidden"> new post</span></a>';
            echo '<a href="/act/post?as='.$blog['name'].'&type=3" class="pure-button button-large"><i class="fa fa-paragraph"></i><span class="kyselo-hidden"> new post</span></a>';
            echo '<a href="/act/post?as='.$blog['name'].'&type=4" class="pure-button button-large"><i class="fa fa-camera"></i><span class="kyselo-hidden"> new post</span></a>';
            echo '<a href="/act/post?as='.$blog['name'].'&type=5" class="pure-button button-large"><i class="fa fa-youtube-play"></i><span class="kyselo-hidden"> new post</span></a>';
            echo '</span>';
        }
